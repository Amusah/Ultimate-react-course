...
export default function App() {
  ...
  */
  ...
  function handleCloseMovie(){ // func declaration by reason of hoisting
    setSelectedId(null);
  };
        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMoviesList
                watched={watched}
                onDeletWatched={handleDeleteWathced}
              />
            </>
          )}
        </Box>
...
const WatchedMoviesList = ({ watched, onDeletWatched }) => {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovies
...
const WatchedMovies = ({ movie, onDeletWatched }) => {
  return (
    <li>
      <img src={movie.poster} alt={`${movie.title} poster`} />
      <h3>{movie.title}</h3>
